import Theme from "../ThemeContextapi/ContextCreate"
function ThemeButton() {

    const { themeMode, darkTheme, lightTheme } = Theme();
    ...
    return (
        <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="ml-3 text-sm font-medium text-gray-900">Toggle Theme</div>
        </label>
    );
}
